...
func (EffectiveAccessScope_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dc9b4bbfaa99ac3e, []int{4, 0}
}
...
// This message created to represent collection of permissions
// Previously we used `Role` for this purpose, but after work on SAC we will not be able to do that
// When `PermissionsSet` can be created and modified my customer, `ResourceToAccess` is internal proto aimed ot reduce
// amount of unnecessary usage of `Role` proto
type ResourceToAccess struct {
...
func (m *ResourceToAccess) Reset()         { *m = ResourceToAccess{} }
func (m *ResourceToAccess) String() string { return proto.CompactTextString(m) }
func (*ResourceToAccess) ProtoMessage()    {}
func (*ResourceToAccess) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc9b4bbfaa99ac3e, []int{3}
}
func (m *ResourceToAccess) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResourceToAccess) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResourceToAccess.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResourceToAccess) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResourceToAccess.Merge(m, src)
}
func (m *ResourceToAccess) XXX_Size() int {
	return m.Size()
}
func (m *ResourceToAccess) XXX_DiscardUnknown() {
	xxx_messageInfo_ResourceToAccess.DiscardUnknown(m)
}

var xxx_messageInfo_ResourceToAccess proto.InternalMessageInfo

func (m *ResourceToAccess) GetResourceToAccess() map[string]Access {
	if m != nil {
		return m.ResourceToAccess
	}
	return nil
...
func (m *ResourceToAccess) MessageClone() proto.Message {
	return m.Clone()
}
func (m *ResourceToAccess) Clone() *ResourceToAccess {
	if m == nil {
		return nil
	}
	cloned := new(ResourceToAccess)
	*cloned = *m
...
func (*EffectiveAccessScope) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc9b4bbfaa99ac3e, []int{4}
}
...
func (*EffectiveAccessScope_Cluster) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc9b4bbfaa99ac3e, []int{4, 1}
}
...
func init() {
	...
	proto.RegisterType((*ResourceToAccess)(nil), "storage.ResourceToAccess")
	proto.RegisterMapType((map[string]Access)(nil), "storage.ResourceToAccess.ResourceToAccessEntry")
...
var fileDescriptor_dc9b4bbfaa99ac3e = []byte{
	...
	,
}
...
func (m *ResourceToAccess) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResourceToAccess) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResourceToAccess) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResourceToAccess) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResourceToAccess) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
