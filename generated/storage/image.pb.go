...
type ImageCVEEdge struct {
	...
	ActiveVulnReqQueue   *VulnRequestQueue  `protobuf:"bytes,4,opt,name=active_vuln_req_queue,json=activeVulnReqQueue,proto3" json:"active_vuln_req_queue,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *ImageCVEEdge) GetActiveVulnReqQueue() *VulnRequestQueue {
	if m != nil {
		return m.ActiveVulnReqQueue
	}
	return nil
}
...
func (m *ImageCVEEdge) Clone() *ImageCVEEdge {
	...
	*cloned = *m
	...
	cloned.ActiveVulnReqQueue = m.ActiveVulnReqQueue.Clone()
	return cloned
}
...
type VulnRequestQueue struct {
	Items                []*VulnRequestQueue_Items `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}

func (m *VulnRequestQueue) Reset()         { *m = VulnRequestQueue{} }
func (m *VulnRequestQueue) String() string { return proto.CompactTextString(m) }
func (*VulnRequestQueue) ProtoMessage()    {}
func (*VulnRequestQueue) Descriptor() ([]byte, []int) {
	return fileDescriptor_c926ac8b7cb24b2e, []int{14}
}
func (m *VulnRequestQueue) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VulnRequestQueue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VulnRequestQueue.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VulnRequestQueue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VulnRequestQueue.Merge(m, src)
}
func (m *VulnRequestQueue) XXX_Size() int {
	return m.Size()
}
func (m *VulnRequestQueue) XXX_DiscardUnknown() {
	xxx_messageInfo_VulnRequestQueue.DiscardUnknown(m)
}

var xxx_messageInfo_VulnRequestQueue proto.InternalMessageInfo

func (m *VulnRequestQueue) GetItems() []*VulnRequestQueue_Items {
	if m != nil {
		return m.Items
	}
	return nil
...
func (m *VulnRequestQueue) MessageClone() proto.Message {
	return m.Clone()
}
func (m *VulnRequestQueue) Clone() *VulnRequestQueue {
	if m == nil {
		return nil
	}
	cloned := new(VulnRequestQueue)
	*cloned = *m

	if m.Items != nil {
		cloned.Items = make([]*VulnRequestQueue_Items, len(m.Items))
...
type VulnRequestQueue_Items struct {
...
func (m *VulnRequestQueue_Items) Reset()         { *m = VulnRequestQueue_Items{} }
func (m *VulnRequestQueue_Items) String() string { return proto.CompactTextString(m) }
func (*VulnRequestQueue_Items) ProtoMessage()    {}
func (*VulnRequestQueue_Items) Descriptor() ([]byte, []int) {
	return fileDescriptor_c926ac8b7cb24b2e, []int{14, 0}
}
func (m *VulnRequestQueue_Items) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VulnRequestQueue_Items) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VulnRequestQueue_Items.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VulnRequestQueue_Items) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VulnRequestQueue_Items.Merge(m, src)
}
func (m *VulnRequestQueue_Items) XXX_Size() int {
	return m.Size()
}
func (m *VulnRequestQueue_Items) XXX_DiscardUnknown() {
	xxx_messageInfo_VulnRequestQueue_Items.DiscardUnknown(m)
}

var xxx_messageInfo_VulnRequestQueue_Items proto.InternalMessageInfo

func (m *VulnRequestQueue_Items) GetRequestId() string {
	if m != nil {
		return m.RequestId
	}
	return ""
...
func (m *VulnRequestQueue_Items) GetTargetState() VulnerabilityState {
	if m != nil {
...
func (m *VulnRequestQueue_Items) MessageClone() proto.Message {
	return m.Clone()
}
func (m *VulnRequestQueue_Items) Clone() *VulnRequestQueue_Items {
	if m == nil {
		return nil
	}
	cloned := new(VulnRequestQueue_Items)
	*cloned = *m
...
func init() {
	...
	proto.RegisterType((*VulnRequestQueue)(nil), "storage.VulnRequestQueue")
	proto.RegisterType((*VulnRequestQueue_Items)(nil), "storage.VulnRequestQueue.Items")
}
...
var fileDescriptor_c926ac8b7cb24b2e = []byte{
	...
	,
}
...
func (m *ImageCVEEdge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ActiveVulnReqQueue != nil {
		{
			size, err := m.ActiveVulnReqQueue.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *VulnRequestQueue) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VulnRequestQueue) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VulnRequestQueue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VulnRequestQueue_Items) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VulnRequestQueue_Items) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VulnRequestQueue_Items) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.TargetState != 0 {
		i = encodeVarintImage(dAtA, i, uint64(m.TargetState))
		i--
		dAtA[i] = 0x10
	}
...
func (m *VulnRequestQueue) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VulnRequestQueue_Items) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TargetState != 0 {
		n += 1 + sovImage(uint64(m.TargetState))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ImageCVEEdge) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActiveVulnReqQueue", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ActiveVulnReqQueue == nil {
				m.ActiveVulnReqQueue = &VulnRequestQueue{}
			}
			if err := m.ActiveVulnReqQueue.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *VulnRequestQueue) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VulnRequestQueue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VulnRequestQueue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Items = append(m.Items, &VulnRequestQueue_Items{})
...
func (m *VulnRequestQueue_Items) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
