...
func (pi generalQueryParser) parse(input string) (*auxpb.Query, error) {
...
func (pi generalQueryParser) parseInternal(fieldMap map[FieldLabel][]string) (*auxpb.Query, error) {
	qb := NewQueryBuilder()
