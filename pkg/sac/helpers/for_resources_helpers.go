...
// subscopes thereof.
func (h ForResourcesHelper) AccessAllowedToAny(ctx context.Context, am storage.Access, keys ...sac.ScopeKey) (bool, error) {
...
func (h ForResourcesHelper) ReadAllowedToAny(ctx context.Context, keys ...sac.ScopeKey) (bool, error) {
...
func (h ForResourcesHelper) WriteAllowedToAny(ctx context.Context, keys ...sac.ScopeKey) (bool, error) {
...
// subscopes thereof.
func (h ForResourcesHelper) AccessAllowedToAll(ctx context.Context, am storage.Access, keys ...sac.ScopeKey) (bool, error) {
	for _, rh := range h.resourceHelpers {
		if ok, err := rh.AccessAllowed(ctx, am, keys...); err != nil || !ok {
			return ok, err
		}
...
func (h ForResourcesHelper) ReadAllowedToAll(ctx context.Context, keys ...sac.ScopeKey) (bool, error) {
...
func (h ForResourcesHelper) WriteAllowedToAll(ctx context.Context, keys ...sac.ScopeKey) (bool, error) {
