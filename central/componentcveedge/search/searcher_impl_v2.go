...
func (ds *searcherImplV2) SearchRawEdges(ctx context.Context, q *aux.Query) ([]*storage.ComponentCVEEdge, error) {
...
func (ds *searcherImplV2) searchComponentCVEEdges(ctx context.Context, q *aux.Query) ([]*storage.ComponentCVEEdge, error) {
	results, err := ds.Search(ctx, q)
	if err != nil {
		return nil, err
	}
