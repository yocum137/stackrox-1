...
func (ds *searcherImpl) SearchRawEdges(ctx context.Context, q *auxpb.Query) ([]*storage.NodeComponentEdge, error) {
...
func (ds *searcherImpl) searchNodeComponentEdges(ctx context.Context, q *auxpb.Query) ([]*storage.NodeComponentEdge, error) {
