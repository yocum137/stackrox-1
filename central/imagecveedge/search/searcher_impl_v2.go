...
func (ds *searcherImplV2) SearchRawEdges(ctx context.Context, q *aux.Query) ([]*storage.ImageCVEEdge, error) {
...
func (ds *searcherImplV2) searchImageComponentEdges(ctx context.Context, q *aux.Query) ([]*storage.ImageCVEEdge, error) {
	results, err := ds.Search(ctx, q)
	if err != nil {
		return nil, err
	}
