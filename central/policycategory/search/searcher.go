...
type Searcher interface {
	...
	SearchCategories(ctx context.Context, q *aux.Query) ([]*v1.SearchResult, error)
	SearchRawCategories(ctx context.Context, q *aux.Query) ([]*storage.PolicyCategory, error)
}
