...
func (m *MockSearcher) SearchPolicies(ctx context.Context, q *aux.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockSearcher) SearchRawPolicies(ctx context.Context, q *aux.Query) ([]*storage.Policy, error) {
	m.ctrl.T.Helper()
