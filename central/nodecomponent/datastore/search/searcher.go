...
type Searcher interface {
	...
	SearchNodeComponents(context.Context, *aux.Query) ([]*v1.SearchResult, error)
	SearchRawNodeComponents(ctx context.Context, query *aux.Query) ([]*storage.NodeComponent, error)
}
