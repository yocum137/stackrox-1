...
type Searcher interface {
	...
	SearchNodeComponents(context.Context, *auxpb.Query) ([]*v1.SearchResult, error)
	SearchRawNodeComponents(ctx context.Context, query *auxpb.Query) ([]*storage.NodeComponent, error)
}
