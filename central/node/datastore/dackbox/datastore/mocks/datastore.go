...
func (m *MockDataStore) SearchNodes(ctx context.Context, q *auxpb.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) SearchRawNodes(ctx context.Context, q *auxpb.Query) ([]*storage.Node, error) {
	m.ctrl.T.Helper()
