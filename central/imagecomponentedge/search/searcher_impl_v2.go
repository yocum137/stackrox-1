...
func (ds *searcherImplV2) SearchRawEdges(ctx context.Context, q *auxpb.Query) ([]*storage.ImageComponentEdge, error) {
...
func (ds *searcherImplV2) searchImageComponentEdges(ctx context.Context, q *auxpb.Query) ([]*storage.ImageComponentEdge, error) {
	results, err := ds.Search(ctx, q)
	if err != nil {
		return nil, err
	}
