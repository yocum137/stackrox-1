...
func (m *MockDataStore) SearchEdges(ctx context.Context, q *aux.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) SearchRawEdges(ctx context.Context, q *aux.Query) ([]*storage.NodeComponentCVEEdge, error) {
	m.ctrl.T.Helper()
