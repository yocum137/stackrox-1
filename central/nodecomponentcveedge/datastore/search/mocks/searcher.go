...
func (m *MockSearcher) SearchEdges(arg0 context.Context, arg1 *auxpb.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockSearcher) SearchRawEdges(ctx context.Context, query *auxpb.Query) ([]*storage.NodeComponentCVEEdge, error) {
	m.ctrl.T.Helper()
