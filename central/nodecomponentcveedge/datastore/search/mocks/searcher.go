...
func (m *MockSearcher) SearchEdges(arg0 context.Context, arg1 *aux.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockSearcher) SearchRawEdges(ctx context.Context, query *aux.Query) ([]*storage.NodeComponentCVEEdge, error) {
	m.ctrl.T.Helper()
