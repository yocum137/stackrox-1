...
type CVELoader interface {
	...
	FromQuery(ctx context.Context, query *auxpb.Query) ([]*storage.CVE, error)
...
func (idl *cveLoaderImpl) FromQuery(ctx context.Context, query *auxpb.Query) ([]*storage.CVE, error) {
...
func (idl *cveLoaderImpl) GetIDs(ctx context.Context, query *auxpb.Query) ([]string, error) {
	results, err := idl.ds.Search(ctx, query)
	if err != nil {
		return nil, err
	}
...
func (idl *cveLoaderImpl) CountFromQuery(ctx context.Context, query *auxpb.Query) (int32, error) {
