...
type NodeCVELoader interface {
	...
	FromQuery(ctx context.Context, query *auxpb.Query) ([]*storage.NodeCVE, error)
...
func (idl *nodeCVELoaderImpl) FromQuery(ctx context.Context, query *auxpb.Query) ([]*storage.NodeCVE, error) {
...
func (idl *nodeCVELoaderImpl) GetIDs(ctx context.Context, query *auxpb.Query) ([]string, error) {
	results, err := idl.ds.Search(ctx, query)
	if err != nil {
		return nil, err
	}
...
func (idl *nodeCVELoaderImpl) CountFromQuery(ctx context.Context, query *auxpb.Query) (int32, error) {
