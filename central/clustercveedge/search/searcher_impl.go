...
func (ds *searcherImpl) SearchRawEdges(ctx context.Context, q *auxpb.Query) ([]*storage.ClusterCVEEdge, error) {
...
func (ds *searcherImpl) searchClusterCVEEdges(ctx context.Context, q *auxpb.Query) ([]*storage.ClusterCVEEdge, error) {
