...
func (m *MockSearcher) SearchRawServiceAccounts(arg0 context.Context, arg1 *aux.Query) ([]*storage.ServiceAccount, error) {
	m.ctrl.T.Helper()
...
func (m *MockSearcher) SearchServiceAccounts(arg0 context.Context, arg1 *aux.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
