...
func (l *loopImpl) runReprocessing(imageFetchOpt imageEnricher.FetchOption) {
	...
	l.reprocessImagesAndResyncDeployments(imageFetchOpt, (*loopImpl).enrichImage)
...
func (l *loopImpl) runSignatureVerificationReprocessing() {
	...
	l.reprocessImagesAndResyncDeployments(imageEnricher.ForceRefetchSignaturesOnly,
		(*loopImpl).forceEnrichImageSignatureVerificationResults)

}

func (l *loopImpl) forceEnrichImageSignatureVerificationResults(ctx context.Context,
...
func (l *loopImpl) enrichImage(_ context.Context,
