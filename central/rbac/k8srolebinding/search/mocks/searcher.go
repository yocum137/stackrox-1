...
func (m *MockSearcher) SearchRawRoleBindings(ctx context.Context, query *auxpb.Query) ([]*storage.K8SRoleBinding, error) {
	m.ctrl.T.Helper()
...
func (m *MockSearcher) SearchRoleBindings(arg0 context.Context, arg1 *auxpb.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
