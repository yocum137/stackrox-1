...
var (
	k8sRolesSACSearchHelper   = helpers.ForResource(resources.K8sRole).MustCreateSearchHelper(mappings.OptionsMap)
	k8sRolesSACPgSearchHelper = helpers.ForResource(resources.K8sRole).MustCreatePgSearchHelper()
)
