...
func (m *MockSearcher) SearchRawRoles(ctx context.Context, query *aux.Query) ([]*storage.K8SRole, error) {
	m.ctrl.T.Helper()
...
func (m *MockSearcher) SearchRoles(arg0 context.Context, arg1 *aux.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
