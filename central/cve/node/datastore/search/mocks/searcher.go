...
func (m *MockSearcher) SearchCVEs(arg0 context.Context, arg1 *auxpb.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockSearcher) SearchRawCVEs(ctx context.Context, query *auxpb.Query) ([]*storage.NodeCVE, error) {
	m.ctrl.T.Helper()
