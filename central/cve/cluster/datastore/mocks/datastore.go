...
func (m *MockDataStore) SearchCVEs(ctx context.Context, q *auxpb.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) SearchRawCVEs(ctx context.Context, q *auxpb.Query) ([]*storage.ClusterCVE, error) {
	m.ctrl.T.Helper()
