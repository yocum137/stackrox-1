...
func (m *MockDataStore) SearchImageCVEs(ctx context.Context, q *aux.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) SearchRawImageCVEs(ctx context.Context, q *aux.Query) ([]*storage.ImageCVE, error) {
	m.ctrl.T.Helper()
