...
func (ds *searcherImpl) SearchImageCVEs(ctx context.Context, q *auxpb.Query) ([]*v1.SearchResult, error) {
...
func (ds *searcherImpl) SearchRawImageCVEs(ctx context.Context, q *auxpb.Query) ([]*storage.ImageCVE, error) {
...
func (ds *searcherImpl) searchCVEs(ctx context.Context, q *auxpb.Query) ([]*storage.ImageCVE, error) {
